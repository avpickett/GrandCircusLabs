...
public class PointofSale {
	...
	public static void main(String[] str) throws IOException {
		...
		BufferedReader reader = new BufferedReader(new FileReader("C:\\Users\\ap_mo\\Desktop\\PointofSales.txt"));
		...
		System.out.println("Welcome! To the Natrual Depot");
		System.out.println("");
...
System.out.println("You Added" + productItem + " to the cart");
